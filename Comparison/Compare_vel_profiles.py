...
plt.plot(time_before, vr_wom_before, color='orange', label='Marie-Josèe Ta Lou', linewidth=2.0)
...
plt.plot(time_between, vr_wom_between, color='orange', linewidth=2.0)
...
plt.plot(time_after, vr_wom_after, color='orange', alpha=0.4, linewidth=2.0)
