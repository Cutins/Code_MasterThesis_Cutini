...
\begin{columns}
\begin{column}{0.55\textwidth}
\onslide<1,2,3,4,5,6,7>\begin{block}{}
\centering
\textcolor{red}{\textbf{Cons of MPC controller}} 
\begin{itemize}
\footnotesize
...
\begin{column}{0.6\textwidth}
	\begin{center}
  		\onslide<5,6,7>\includegraphics[width=1.05\textwidth]{MPC_ofhard_scheme} 
	\end{center}
\end{column}
\hspace{0.2cm}
\begin{column}{0.43\textwidth}
...
\onslide<7>\begin{column}{0.7\textwidth}
\begin{block}{}
\centering
...
\onslide<1,2,3,4,5,6,7> \color{gray} \scriptsize $^1$ U. Maeder, F. Borrelli, M. Morari \\ 
